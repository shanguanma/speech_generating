...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            required=True,
            help="Domain A train set(we assume it should be clean speech data)",
        )
        parser.add_argument(
            "--dir_trainB",
            type=str,
            required=True,
            help="Domain B train set(we assume it should be target noisy speech data)",
        )
        ...
        parser.add_argument(
            ...
            type=str,
            required=True,
            help="Domain A valid set(we assume it should be clean speech data)",
        )
        parser.add_argument(
            "--dir_validB",
            type=str,
            required=True,
            help="Domain B valid set(we assume it should be target noisy speech data)",
        )
        parser.add_argument(
            "--dir_testA",
            type=str,
            required=True,
            help="Domain A test set(we assume it should be clean speech data)",
        )
        parser.add_argument(
            "--name",
            type=str,
        ...
        # model parameters
        parser.add_argument(
            "--model", type=str, default="cut", help="chooses which model to use."
        )
        parser.add_argument(
            "--input_nc",
            type=int,
        ...
        parser.add_argument(
            ...
            type=str,
            default="unpairedscp",
            help="chooses how datasets are loaded. [unaligned | aligned | single | colorization | unpairedscp ]",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            type=float,
            default=1.0,
            help="number to raise the spectrogram with before applying the transforms",
        )
        parser.add_argument(
            "--state",
            type=str,
            default="Train",
            help="State of the model; decides how components are returned in the dataloader",
        )
        parser.add_argument(
            "--parallel_data",
            type=int,
            default=0,
            help="Decides whether to take parallel data (1) for training or to take randomly (0)",
        )
        parser.add_argument(
            "--single_channel",
            type=int,
            default=1,
            help="Decides if input images(spectrograms) are single channel (1) or not (0)",
        )
        parser.add_argument(
            "--display_winsize",
            type=int,
